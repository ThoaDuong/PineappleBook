	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				...
				<form method="post" action="discount-edit-{{$discount->discount_id}}">
					{{ csrf_field() }}
					<div class="modal-body">
						<div class="form-row">
							<div class="form-group col-md-3">
								<label class="font-weight-bold">Discount's ID</label>
								<input type="text" class="form-control" name="discount_id" value="{{$discount->discount_id}}">
							</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="number" value="{{$discount->number}}">
						</div>
